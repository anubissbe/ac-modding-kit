...
confidentially to the project maintainers through GitHub's private vulnerability
reporting form under the repository's **Security** tab. Start the report title with
`Code of Conduct`. Do not report conduct incidents in a public issue.
